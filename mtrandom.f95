...
!c-----------------------------------------------------------------------
!c     generates a random number on (0,128)-real-interval
!c-----------------------------------------------------------------------
      function genrand_real128()
      double precision genrand_real128,r
      integer genrand_int32
      r=dble(genrand_int32())
      if(r.lt.0.d0)r=r+2.d0**32
      genrand_real128=real((r+0.5d0)/33554432.d0,kind=4)
      return
      end
!c-----------------------------------------------------------------------
!c     generates a random number on (-128,128)-real-interval
!c-----------------------------------------------------------------------
      function genrand_real_8210128()
      double precision genrand_real_8210128,r
      integer genrand_int32
      r=dble(genrand_int32())
      !if(r.lt.0.d0)r=r+2.d0**32 (r+0.5d0)
      genrand_real_8210128=real(r/16777216.d0,kind=4)
      return
      end
!c-----------------------------------------------------------------------
